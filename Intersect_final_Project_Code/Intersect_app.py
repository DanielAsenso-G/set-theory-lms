...
# Ensure all file paths are correctly updated to the 'pages' directory
# and that image references, if any, are updated to the 'images' folder.

quiz_generator_page = st.Page(
    page = "pages/quiz_generator.py",
    title = "Quiz",
    icon = "🎓"
)
...
Relations_page = st.Page(
    page = "pages/Relations.py",
    title = "Set Relations",
    icon = "📝"
)

Special_page = st.Page(
    page = "pages/Special.py",
    title = "Special",
    icon = "📝"
)

set_visualizer_page = st.Page(
    page = "pages/set_visualizers.py",
...
pg = st.navigation(
    {
        "General" : [home_page],
        "Modules" : [
            Introduction_to_sets_page, 
            Operations_page, 
            Relations_page, 
            Special_page,
            Sets_Theoretic_Laws_page,
            Interactive_Proof_in_set_theory_page,
            ApplicationsOfSets_page,
            Advanced_Applications_on_sets_page
        ],
